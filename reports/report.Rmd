...
moe <- qt(0.975, 2) * desvest/sqrt(N) #margen de error para las cocnetraciones finales de HTP usando una distribución t.
...
Se realiaza un test "t" y se obtiene un valor de p de 0.3%. Esto indica que hay un 0.3% de probabilidad de que la diferencia obtenida entre los promedios de las concentraciones finales de HTP para los tratamientos atenuación natural y bioestimulación sea producto del azar.
