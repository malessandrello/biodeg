...
Se dipusieron pilas de 100 litros de suelo contaminado con hidrocarburos (concentración inicial: 36919 mg/kg) a las cuales se les realizaron los siguientes tratamientos:  
...
* Teniendo en cuenta que el efecto de la adición de fertilizante enmasacara el efecto que pudiera tener la adición de   biosurfactante o de P26, los tres ensayos a los que se les agregó fertilizante pueden considerarse réplicas de un mismo tratamiento. A este tratamineto lo llamaremos tratamiento con fertilizante o biosetimulación.  

* El porcentaje de margen de error obtenida para los tratamientos con fertilizante será utilizado también para el tratamiento de atenuiacón natural, ante la imposibilidad de contar con réplicas de este tratamiento.  
...
Se realiaza un test "t" y se obtiene un valor de p de 0.3%. Esto indica que hay un 0.3% de probabilidad de que los resultados obtenidos sean producto del azar.
...
* La sola adición de fertilizante es suficiente para un tratamiento eficiente.  
